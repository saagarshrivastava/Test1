...
@RestController
@RequestMapping("/api/test-1-kafka")
public class Test1KafkaResource {
    private final Logger log = LoggerFactory.getLogger(Test1KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public Test1KafkaResource(KafkaProperties kafkaProperties) {
